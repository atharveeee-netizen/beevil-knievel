      ...
      <div className="max-w-[1360px] mx-auto space-y-24">
        ...
        <div className="space-y-4 max-w-4xl">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0b0f19] border border-white/10 text-xs font-mono tracking-wider text-[#94a3b8]">
            ...
            <span className="text-amber-400 font-bold">ROBU / PCBPOWER VERIFIED BOM</span>
          </div>

          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-[#f8fafc] font-sans">
            Hardware architecture engineered for empirical precision.
          </h2>

          <p className="text-base sm:text-lg text-[#94a3b8] leading-relaxed font-normal">
            Three interconnected cyber-physical hardware tiers engineered to operate autonomously in commercial field environments.
          </p>
        </div>
          ...
          >
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs font-mono text-[#94a3b8] mt-1">Nordic nRF52840 • FreeRTOS 2.0µA Sleep</p>
                <p className="text-xs text-[#94a3b8] mt-2 leading-relaxed">
                  IP67 CNC polycarbonate enclosure with tool-less magnetic quick-dock mounting (30s deploy). Runs on-node TinyML 1D-CNN triage in 1.12 ms with 99.80% recall, suppressing 91.4% redundant radio transmissions.
                </p>
              </div>
            </div>
            ...
            <div className="pt-4 mt-4 border-t border-white/10 flex items-center justify-between text-[11px] font-mono">
              ...
              <span className="text-slate-400">3.2+ Yr Battery</span>
            </div>
          </SpotlightCard>
          ...
          >
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs font-mono text-[#94a3b8] mt-1">6 TOPS NPU • Debian 64-bit • SQLite WAL</p>
                <p className="text-xs text-[#94a3b8] mt-2 leading-relaxed">
                  Open-source Antmicro baseboard hosting Raspberry Pi Compute Module 4 with dedicated 6 TOPS edge NPU. Aggregates up to 100 field hives across 15 km LoRaWAN IN865 mesh with 8.2ms INT8 neural inference.
                </p>
              </div>
            </div>
            ...
            <div className="pt-4 mt-4 border-t border-white/10 flex items-center justify-between text-[11px] font-mono">
              ...
              <span className="text-slate-400">96.84% Accuracy</span>
            </div>
          </SpotlightCard>
          ...
          >
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs font-mono text-[#94a3b8] mt-1">Immutable Merkle Batch Pass • QR Seal</p>
                <p className="text-xs text-[#94a3b8] mt-2 leading-relaxed">
                  Every honey batch is sealed with an immutable SHA-256 Merkle root. Over 1,050,000 multi-sensor readings verify 45 days of continuous queenright brood homeostasis, zero chemical treatments, and authentic floral harvest.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs font-mono text-[#94a3b8] mt-0.5">Component-level silicon precision from verified suppliers</p>
            </div>
          </div>
        ...
        <div id="mesh" className="bg-[#0b0f19]/90 border border-white/10 p-6 sm:p-8 rounded-2xl space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-white/10">
            <div className="space-y-1">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-[#f8fafc]">
                Self-healing dynamic tree mesh across 15 km line-of-sight
              </h3>
            </div>
            <div className="flex items-center gap-2 font-mono text-xs text-[#94a3b8]">
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
              <span>Semtech SX1262 (+22 dBm Tx)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
            <div className="bg-[#070a12] border border-white/5 p-4 rounded-xl space-y-1.5">
              ...
              <div className="text-[11px] font-mono text-slate-400">Adaptive Data Rate (ADR SF7-SF12)</div>
            </div>
            ...
            <div className="bg-[#070a12] border border-white/5 p-4 rounded-xl space-y-1.5">
              ...
              <div className="text-[11px] font-mono text-slate-400">3-Hop Auto-Rerouting Tree Topology</div>
            </div>
            ...
            <div className="bg-[#070a12] border border-white/5 p-4 rounded-xl space-y-1.5">
              ...
              <div className="text-[11px] font-mono text-slate-400">Dual-Layer AES-256 Cryptographic Vault</div>
            </div>
          </div>
        </div>
        ...
        <div id="the_crank" className="bg-[#0b0f19]/90 border border-white/10 p-6 sm:p-8 rounded-2xl space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-white/10">
            ...
            <div className="text-xs font-mono text-[#94a3b8]">
              128-Point CMSIS-DSP FFT on ARM Cortex-M4F
            </div>
          </div>
