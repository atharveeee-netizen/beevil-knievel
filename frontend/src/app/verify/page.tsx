...
function VerifyContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#090b10] text-[#f1f5f9] font-sans">
      <Navbar />
      <div className="flex-grow p-8">
        <div className="max-w-2xl mx-auto border border-slate-800 rounded-xl bg-slate-900/50 p-6 backdrop-blur-sm mt-12">
          <h1 className="text-3xl font-bold text-[#f59e0b] mb-2">HoneyChain Passport</h1>
          ...
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 rounded-lg bg-amber-950/30 border border-amber-900/50">
                <h2 className="text-xl font-semibold text-[#f59e0b] flex items-center gap-2">
              ...
              <button className="w-full py-3 rounded-lg bg-[#f59e0b] hover:bg-amber-500 text-[#090b10] font-semibold transition-colors">
