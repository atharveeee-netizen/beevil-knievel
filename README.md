...
The platform combines a **Nordic nRF52840 + Semtech SX1262 (RAK4631 Core SoC)** edge transmitter node with on-device TinyML inference (**Model 1 & Model V2**), multi-spectral acoustic feature extraction, Sub-GHz LoRaWAN transmission, and a **Raspberry Pi CM4 + Google Coral Edge TPU** gateway pathology diagnostic engine (**Model 2**).
...
|  |                                                                                              |  |
|  |  [Model V2 TinyML]: Int8 Quantized Dense NN (980 Bytes Flash, 4 KB SRAM Arena, <1.0ms)        |  |
...
├── model_v2/                        # Model V2 TinyML On-Node Triage Engine (nRF52840)
...
│   └── transmitter_firmware/        # nRF52840 main loop & SX1262 LoRa selective triage firmware
...
├── smart_hive_node.net              # Hive Node Netlist Mappings
...
| :--- | :--- | :--- | :--- |
| **Model V2 Triage Engine** | Nordic nRF52840 + SX1262 | **980 Bytes Flash / 4 KB SRAM** | **99.80% Triage Acc (0 False Negatives)** |
| **Model 1 Acoustic Engine** | nRF52840 (64MHz M4F) | 75.4 KB Flash / 14.2 KB SRAM | 96.4% 1D-CNN Classifier Accuracy |
