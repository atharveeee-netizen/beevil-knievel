...
| `docs/media/hardware/antmicro_cm4_baseboard_schematic.jpg` | **`EXTERNAL RESEARCH REFERENCE`** | Antmicro Open Source Hardware | Apache 2.0 | Raspberry Pi 3B+ Baseboard carrier board schematic & layout reference | 2026-09-06 |
